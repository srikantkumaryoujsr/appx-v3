...
# Assuming main.py has AUTH_USERS defined
...
async def all_subject_send(bot):
    subject_and_channel = {
        848: -1002172298027, 849: -1002235512099, 850: -1002211669142,
        851: -1002180965513, 852: -1002161059509, 853: -1002149612783,
        854: -1002166225417
    }
        ...
        try:
            ...
            for t in topicids:
                ...
                try:
                    ...
                    print(f"Exception in processing video data: {e}")
