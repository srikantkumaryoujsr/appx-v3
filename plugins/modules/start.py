...
async def start_message(bot, message: Message):
    if not check_subscription(message.from_user.id):
        await message.reply_text(f"😂 अरे भाई/बहन, लगता है आपको हमारी VIP टीम का हिस्सा बनने की बड़ी जल्दी है! \nलेकिन थोड़ा ठहरिए, ये **सिर्फ एडमिन्स** के लिए है।\n\nअगर आप भी एडमिन बनना चाहते हैं, तो पहले सही दरवाजा खटखटाइए 😉।\nतब तक, हमारी शुभकामनाएं आपके साथ हैं! ❤️\n\n_सप्रेम, आपका Telegram Bot_")
        return
