    ...
    async with aiohttp.ClientSession() as session:
        try:
            ...
            if date not in all_important:
                ...
                messages = {
                    828: f"Maths (RPF रक्षक बैच ){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    829: f"Reasoning (RPF रक्षक बैच ){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    830: f"Economics (RPF रक्षक बैच ){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    831: f"Geography (RPF रक्षक बैच ){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    832: f"History (RPF रक्षक बैच ){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    833: f" Physics (RPF रक्षक बैच ){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    917: f"Biology (RPF रक्षक बैच){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    935: f"Static GK (RPF रक्षक बैच){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    958: f"polity (RPF रक्षक बैच ){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    1050: f"Chemistry (RPF रक्षक बैच){get_current_date_vsp()}\n** Note⚠️ :-  या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
