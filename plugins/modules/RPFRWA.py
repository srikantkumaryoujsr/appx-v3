...
async def all_subject_send(bot):
    ...
    try:
        await bot.send_message(
            chat_id=-1002057819179,
            text=(
                "*♻️𝐒𝐭𝐮𝐝𝐞𝐧𝐭𝐬 𝐀𝐚𝐩𝐤𝐢 𝐂𝐥𝐚𝐬𝐬 𝐔𝐩𝐝𝐚𝐭𝐞 𝐊𝐚𝐫 𝐃𝐢 𝐠𝐚𝐢 𝐇𝐚𝐢 ♻️*\n"
    ...
    async with aiohttp.ClientSession() as session:
        try:
            ...
            if date not in all_important:
                ...
                messages = {
                    828: "*Maths (RPF रक्षक बैच )*\n**> Note⚠️ :- या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    829: "*Reasoning (RPF रक्षक बैच )*\n**> Note⚠️ :- या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    830: "*Economics (RPF रक्षक बैच )*\n**> Note⚠️ :- या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    831: "*Geography (RPF रक्षक बैच )*\n**> Note⚠️ :- या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    832: "*History (RPF रक्षक बैच )*\n**> Note⚠️ :- या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    833: "*Physics (RPF रक्षक बैच )*\n**> Note⚠️ :- या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    917: "*Biology (RPF रक्षक बैच)*\n**> Note⚠️ :- या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    935: "*Static GK (RPF रक्षक बैच)*\n**> Note⚠️ :- या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
                    958: "*Polity (RPF रक्षक बैच )*\n**> Note⚠️ :- या तो इस सब्जेक्ट में कल क्लास नहीं हुई थी या तो यह सब्जेक्ट में क्लासेस कंप्लीट हो गई है**",
