...
async def all_subject_send(bot):
    ...
    try:
        await bot.send_message(
            chat_id=-1002272764580,
            text=f"**️जिन बच्चों के पास इंटरनेट का अभाव या फिर वह मोबाइल इंटरनेट का उपयोग करते हैं तो आप काम क्वालिटी वाले चैनल से जुड़ सकते हैं 𝗤𝘂𝗮𝗹𝗶𝘁𝘆:- 𝟯𝟲𝟬𝗽😋https://t.me/RWA_AVSAR_2_0_BATCH_SSC_GD **"
        )
        await bot.send_message(
            chat_id=-1002272764580,
            text=f"**🔆𝐒𝐭𝐮𝐝𝐞𝐧𝐭𝐬 𝐀𝐚𝐩𝐤𝐢 𝐂𝐥𝐚𝐬𝐬{get_current_date_vsp()}**\n**𝐔𝐩𝐝𝐚𝐭𝐞 𝐊𝐚𝐫 𝐃𝐢 𝐠𝐚𝐢 𝐇𝐚𝐢 🔆**```\nNote :- जितने भी मेरे साथी मित्र टेलीग्राम से सर्च करके हमारे चैनल तक पहुंच रहे हैं उनसे अनुरोध है कि आप चैनल को ज्वाइन कर लीजिए यहां पर आपको फ्री में क्लासेस उपलब्ध कराई जा रही है प्रतिदिन किसी को पैसे देने की जरूरत नहीं है 𝟏𝟎𝟎 ❤️𝐃𝐚𝐢𝐥𝐲 𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧 𝐦𝐢𝐥𝐧𝐞 𝐜𝐡𝐚𝐡𝐢𝐲𝐞 𝐠𝐮𝐲𝐬 🕊️\n```🔅𝐐𝐮𝐚𝐥𝐢𝐭𝐲🔅:➤ 𝟕𝟐𝟎𝐩\n🌟[𝐉𝐨𝐢𝐧 𝟑𝟔𝟎𝐩 𝐐𝐮𝐚𝐥𝐢𝐭𝐲 𝐂𝐡𝐚𝐧𝐧𝐞𝐥](https://t.me/+SVnm5JcoBIUxMDhl)🌟\n❤️𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧𝐬 𝐝𝐨 𝐘𝐚𝐚𝐫❤️"
        )
    except Exception as e:
