...
async def all_subject_send(bot):
    subject_and_channel = {1088: -1002027204435, 1090: -1002027204435, 1091: -1002027204435, 1092: -1002027204435, 1093: -1002027204435, 1094: -1002027204435}
    
    try:
        start_message = await bot.send_message(
            chat_id=-1002027204435,
        ...
        try:
            await bot.pin_chat_message(chat_id=-1002027204435, message_id=start_message.id)
            await bot.delete_messages(chat_id=-1002027204435, message_ids=[start_message.id + 1])
    ...
    try:
        ...
        await bot.send_message(
            chat_id=-1002027204435,
            text=f"**🔆𝐒𝐭𝐮𝐝𝐞𝐧𝐭𝐬 𝐀𝐚𝐩𝐤𝐢 𝐂𝐥𝐚𝐬𝐬 {get_current_date_vsp()}**\n**𝐔𝐩𝐝𝐚𝐭𝐞 𝐊𝐚𝐫 𝐃𝐢 𝐠𝐚𝐢 𝐇𝐚𝐢 🔆**```\nNote :- जितने भी मेरे साथी मित्र टेलीग्राम से सर्च करके हमारे चैनल तक पहुंच रहे हैं उनसे अनुरोध है कि आप चैनल को ज्वाइन कर लीजिए यहां पर आपको फ्री में क्लासेस उपलब्ध कराई जा रही है प्रतिदिन किसी को पैसे देने की जरूरत नहीं है❤ 𝟏𝟎𝟎 ❤️𝐃𝐚𝐢𝐥𝐲 𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧 𝐌𝐞 𝐦𝐢𝐥𝐧𝐞 𝐜𝐡𝐚𝐡𝐢𝐲𝐞 𝐠𝐮𝐲𝐬 🕊️\n```**❤️𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧𝐬 𝐝𝐨 𝐘𝐚𝐚𝐫❤️ **"
        )
    except Exception as e:
