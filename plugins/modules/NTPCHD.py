...
async def all_subject_send(bot):
    ...
    try:
        await bot.send_message(
            chat_id=-1002003601367,
            text=f"**जिन बच्चों के पास इंटरनेट का अभाव या फिर वह मोबाइल इंटरनेट का उपयोग करते हैं तो आप काम क्वालिटी वाले चैनल से जुड़ सकते हैं 𝗤𝘂𝗮𝗹𝗶𝘁𝘆:- 𝟯𝟲𝟬𝗽😋 @RWA_RRB_NTPC_GATIMAN_BATCH_2024 **"
        )
        await bot.send_message(
            chat_id=-1002003601367,
